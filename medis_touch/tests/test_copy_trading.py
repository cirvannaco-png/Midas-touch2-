...
def test_copy_idempotency_is_scoped_per_account():
    assert account_scoped_idempotency_key(
        signal_id="sig-1", account_id="acct-a"
    ) != account_scoped_idempotency_key(signal_id="sig-1", account_id="acct-b")
