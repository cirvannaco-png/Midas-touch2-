...
def downgrade() -> None:
    ...
    op.drop_index("ix_promotion_requests_instrument", table_name="promotion_requests")
    op.drop_index("ix_promotion_requests_config_hash", table_name="promotion_requests")
